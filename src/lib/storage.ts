...
import { AppState, Product, Client, Supplier, PurchaseInvoice, PurchasePayment } from './types';
...
export const PROVEEDORES_INICIALES: Supplier[] = [
  {id:1,nombre:'Distribuidora Nacional de Aceites SA de CV',rif:'J-12345678-9',contacto:'Juan Pérez',telefono:'555-800-1000',email:'ventas@dna.com',direccion:'Zona Industrial #200',categoria:'lubricante',notas:'Entrega los martes'}
];
